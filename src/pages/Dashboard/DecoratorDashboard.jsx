...
import UserDashboard from "./UserDashboard"; // Import the layout component

import {
  formatBookingId,
  sanitizeBookingData,
  isBookingCancelled,
  canDecoratorUpdateStatus,
...
const DecoratorDashboardContent = () => {
  ...
  const getStatusInfo = (status) => {
    ...
    return (
      statusMap[status] || { color: "bg-gray-500", icon: FaClock, text: status }
    );
  };
  ...
  return (
    <>
      {/* Header Section */}
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl mb-8 -mt-6 -mx-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-purple-100 text-lg">
              Manage your decoration projects and create beautiful experiences
            </p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="text-3xl font-bold text-orange-600 mb-1">
                {bookings?.filter(
                  (b) => b.status !== "Completed" && !isBookingCancelled(b)
                ).length || 0}
              </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <select
            ...
            className="px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all shadow-sm text-gray-900 font-medium"
          >
            ...
            <option value="Cancelled" className="font-medium">
              Cancelled
            </option>
          </select>
          ...
          >
            ...
            <option value="serviceName" className="font-medium">
              🎨 Service Name
            </option>
            <option value="status" className="font-medium">
              📋 Status
            </option>
            <option value="userName" className="font-medium">
              👤 Client Name
            </option>
          </select>
        </div>
        ...
        <div className="flex flex-wrap justify-between items-center text-sm">
          <span className="text-gray-600 font-medium">
            📊 Showing{" "}
            <span className="text-indigo-600 font-bold">{totalResults}</span> of{" "}
            <span className="font-bold">{bookings?.length || 0}</span> projects
          </span>
          {searchTerm && (
            ...
            <div className="grid gap-4">
              {todayProjects.map((project, index) => {
                ...
                return (
                  <div
                    key={project._id}
                    className="flex items-center p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500"
                  >
                    <div
                      className={`w-12 h-12 ${statusInfo.color} rounded-full flex items-center justify-center mr-4`}
                    >
              ...
              {paginatedBookings.map((b, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <div
                        className={`flex items-center p-3 rounded-xl ${statusInfo.color} text-white shadow-md`}
                      >
                    ...
                    <div className="space-y-3">
                      ...
                      {canUpdate ? (
                        <select
                          ...
                          value={b.status}
                          onChange={(e) =>
                            handleUpdateStatus(b._id, e.target.value)
                          }
                        ...
                        >
                          {PROJECT_STATUSES.map((s) => {
                            ...
                            const isDisabled =
                              PROJECT_STATUSES.indexOf(s) <
                              PROJECT_STATUSES.indexOf(b.status);
                            return (
...
export default function DecoratorDashboard() {
  return (
    <BookingErrorBoundary>
      <UserDashboard content={<DecoratorDashboardContent />} />
    </BookingErrorBoundary>
  );
}
