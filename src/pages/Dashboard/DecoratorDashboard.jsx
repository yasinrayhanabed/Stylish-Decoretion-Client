...
export default function DecoratorDashboard() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-3xl text-blue-700 font-bold mb-6 text-primary">
         Decorator Dashboard
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-600 rounded shadow font-semibold text-lg">
