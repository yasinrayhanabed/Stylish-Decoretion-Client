...
export default function AdminDecoratorRequests() {
  ...
  const handleApprove = async (requestId) => {
    if (
      !window.confirm(
        "Are you sure you want to approve this decorator request?"
      )
    )
      return;
  ...
  const handleReject = async (requestId) => {
    if (
      !window.confirm("Are you sure you want to reject this decorator request?")
    )
      return;
        ...
        {requests.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h4 className="text-2xl font-bold text-gray-700 mb-3">
              No Decorator Requests
            </h4>
            <p className="text-gray-500 text-lg">
              No users have applied to become decorators yet.
            </p>
          </div>
        ) : (
            ...
            {requests.map((request) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  ...
                  {/* Action Buttons */}
                  <div className="flex flex-row sm:flex-col flex-wrap gap-2 order-1 sm:order-2 sm:ml-4">
                    {request.portfolio && (
                      <a
                        href={request.portfolio}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-3 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg transition-colors flex items-center justify-center text-sm font-medium"
                      >
                    ...
                    {request.status === "pending" && (
                      <>
                        <button
                          ...
                          className="px-3 py-2 bg-green-100 hover:bg-green-200 text-green-700 rounded-lg transition-colors flex items-center justify-center text-sm font-medium disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={processingId === request._id}
                          className="px-3 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg transition-colors flex items-center justify-center text-sm font-medium disabled:opacity-50"
                        >
