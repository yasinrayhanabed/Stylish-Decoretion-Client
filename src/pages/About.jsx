...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-5 py-20">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white shadow-lg rounded-xl p-6 hover:scale-105 transition-transform">
          ...
          <p className="text-gray-600">Skilled decorators with years of experience to make your events perfect.</p>
        </div>
        <div className="bg-white shadow-lg rounded-xl p-6 hover:scale-105 transition-transform">
          <h3 className="text-xl font-semibold mb-2">Customized Packages</h3>
          <p className="text-gray-600">Tailored services for homes, weddings, parties, and corporate events.</p>
        </div>
        <div className="bg-white shadow-lg rounded-xl p-6 hover:scale-105 transition-transform">
          <h3 className="text-xl font-semibold mb-2">Smart Scheduling</h3>
          <p className="text-gray-600">Book your service online with real-time availability and tracking.</p>
        </div>
      </div>
    </div>
  );
