      ...
      >
        <div className="hero-content text-center text-white">
          <div className="max-w-4xl">
            ...
            >
              Professional decoration services for homes, weddings, and events.
              Book consultations and on-site services with expert decorators.
            </motion.p>
            <motion.div
            ...
            >
              ...
              <Link
                to="/about"
                className="btn btn-outline btn-lg text-white border-white hover:bg-white hover:text-purple-600"
              >
                Learn More
              </Link>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Discover our most loved decoration services, crafted with
          ...
          {services === null ? (
            ...
            >
              ...
              <p className="text-base-content/70">
                We're preparing amazing decoration services for you
              </p>
            </motion.div>
          ) : (
            <motion.div
      ...
      <section className="py-20 bg-base-200">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Expert interior designers with highest customer ratings, ready to
              ...
              <Marker position={[23.8103, 90.4125]}>
                <Popup>
                  <div className="text-center">
                    <strong>StyleDecor Service Area</strong>
                    <br />
